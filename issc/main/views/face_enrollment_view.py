...
def face_enrollment_view(request, id_number):
    ...
    if request.method == "POST":
        ...
        print("Front Image:", front_image[:50] if front_image else "None")
        print("Left Image:", left_image[:50] if left_image else "None")
        print("Right Image:", right_image[:50] if right_image else "None")
